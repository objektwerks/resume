...
* 2023 | Objektwerks, FL | Scala Engineer ~ Designed and built distributed client-server app, **Health Balance**. [Scala 3, ScalaFx, Jsoniter, Scaffeine, JoddMail, PostgreSql, Sbt, Git] (github.com/objektwerks/health.balance)
