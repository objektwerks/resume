...
* 2024 | Objektwerks, FL | Scala Engineer ~ Designed and built open source client-server app, **Lawncare**, allowing lawncare providers to track properties, sessions and issues. [Scala 3, ScalaFx, Jsoniter, Scaffeine, JoddMail, ScalikeJdbc, PostgreSql, Helidon, Sbt, Git] (github.com/objektwerks/lawncare)
