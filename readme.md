...
2013.1 – Present | Objektwerks, FL | Consultant | Scala Engineer ~ Design and build Scala distributed and desktop apps. [Scala 2/3, Spark, Swing, JFreeChart, ScalaFx, ScalaJs, Laminar, Akka-Typed, Akka-Http, Quill, PostgreSQL, uPickle, Sbt, Git] [Kotlin, Arrow, Ktor, Exposed, Gradle] [Rust, Hyper, Reqwest, Serde, Cargo]
