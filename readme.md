...
* 2020 - 2021 | Objektwerks, FL | Healthcharts | Scala Engineer ~ Designed and built an open source, cross-platform desktop app, sourced by csv-txt files, targeting 11 health charts. Upgraded to Scala 3 on 2022.3.8. [Scala 2/3, Swing, JFreeCharts, Sbt, Git] (https://github.com/objektwerks/healthcharts)
...
* 2017 | Objektwerks, FL | Poolmate | Scala Engineer ~ Designed and built open source, cross-platform pool management desktop app with H2 store. [Scala 2.13, ScalaFX 14-R19, H2, Sbt, Git] (https://github.com/objektwerks/poolmate)
